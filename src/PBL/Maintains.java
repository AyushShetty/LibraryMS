...
public class Maintains extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book Code", "Branch No", "Units On Hand"
            }
        ));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try
        {
            ...
            //String branch_number=jTextField2.getText();
            //String units_on_hand = jTextField4.getText();
            //System.out.println("Display:"+ branch_number);

            stmt = c.createStatement();
            String sql = "DELETE FROM maintains WHERE book_code='"+(book_code)+"';";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            String book_code=jTextField1.getText();
            Integer branch_number=Integer.parseInt(jTextField2.getText());
            Integer units_on_hand=Integer.parseInt(jTextField4.getText());
            //System.out.println("Display:"+ branch_number);

            stmt = c.createStatement();
            String sql = "UPDATE maintains SET units_on_hand='"+(units_on_hand)+"' where book_code='"+(book_code)+" and  branch_number='"+(branch_number)+"';";
       ...
       catch(ClassNotFoundException | SQLException |NumberFormatException e)
        {
            ...
            {
                JOptionPane.showMessageDialog(this,"Integer expected at Branch No. OR Units On Hand");
            }
            else
            {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                String units_on_hand=rs.getString("units_on_hand");
                //System.out.println(book_code+ "|" + author_no + "|"+ sequence_number);
                model.addRow(new Object[]{book_code,branch_number,units_on_hand});
            }
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            stmt = c.createStatement();
            String sql = "INSERT INTO maintains VALUES ('"+(book_code)+"', '"+(branch_number)+"', '"+(units_on_hand)+"');";
             if(jTextField1.getText().isEmpty()==true||jTextField2.getText().isEmpty()==true||jTextField4.getText().isEmpty()==true)
         {
        ...
        catch(ClassNotFoundException | SQLException |NumberFormatException e)
        {
            ...
            if(msg.contains("unique")==true)
            {
            JOptionPane.showMessageDialog(this,"Book Code "+jTextField1.getText()+" and Branch no "+jTextField2.getText()+" already exists! Cannot Insert Data");
            }
            else if(msg.contains("input")==true)
            {
                JOptionPane.showMessageDialog(this,"Integer expected at Branch No. OR Units On Hand");
